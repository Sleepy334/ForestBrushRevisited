...
{
    public class TreeItemRow : UIPanel, IUIFastListRow
    {
        ...
        private void Initialize(TreeInfo info)
        {
            ...
            if (m_steamIcon != null)
            {
                ...
                m_steamIcon.width = 25f;
                m_steamIcon.height = 15f;
                m_steamIcon.isVisible = true;// false;
                m_steamIcon.relativePosition = new Vector3(width - 48f, 7.5f);
            }
        ...
        {
            if (!ModSettings.Settings.ShowTreeMeshData)
            {
                tooltip = "";
            }
        ...
        public void Display(object data, bool isRowOdd)
        {
            ...
            if (m_steamIcon != null)
            {
                m_steamIcon.isVisible = Prefab.name.Contains('.'); 
            }
