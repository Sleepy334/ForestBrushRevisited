...
namespace ForestBrushRevisited
{
    public static class Debug
    {
        ...
        {
            UnityEngine.Debug.Log($"[{Constants.ModName}] {GetCallingFunction()}:\n" + sText);
        }

        public static void LogError(string sText)
        {
            UnityEngine.Debug.LogError($"[{Constants.ModName}] {GetCallingFunction()}:\n" + sText);
        }

        public static void LogWarning(string sText)
        {
            UnityEngine.Debug.LogWarning($"[{Constants.ModName}] {GetCallingFunction()}:\n" + sText);
        }
