...
namespace ForestBrushRevisited
{
    public class Localization
    {
        ...
        private static void LoadAllLanguageFiles()
        {
            ...
            {
                s_localeStore.Add("en", LocaleFromResource(Constants.DllName + ".Locales.en.csv"));
            }
        }

        private static Locale LocaleFromFile(string file)
        {
            Debug.Log("LocaleFromFile");
        ...
        {
            string sLanguage = (ModSettings.Settings is not null) ? ModSettings.Settings.PreferredLanguage : SYSTEM_DEFAULT;
