    ...
    internal class SettingsUI
    {
        ...
        public void OnSettingsUI(UIHelperBase helper)
        {
            try
            {
                ...
                {
                    ModSettings defaltSettings = ModSettings.Default();
                    ModSettings.Settings.PanelPosX = defaltSettings.PanelPosX;
                    ModSettings.Settings.PanelPosY = defaltSettings.PanelPosY;
                    ModSettings.SaveSettings();
