...
namespace ForestBrushRevisited
{
    ...
    public class ResourceLoader
    {
        ...
        public static string ShowBrushTrees { get; } = "BrushIcon"; 

        private static Shader? s_shader = null;
        private static UITextureAtlas? s_atlas = null;
        private static UITextureAtlas? s_forestBrushAtlas = null;
        ...
        public static Shader? Shader
        {
            get
            {
                if (s_shader == null)
                {
                    s_shader = LoadCustomShaderFromBundle();
                }
        ...
        internal static UITextureAtlas? ForestBrushAtlas
        {
            get
            {
                if (s_forestBrushAtlas == null)
                {
                    s_forestBrushAtlas = LoadAtlas();
                }
                return s_forestBrushAtlas;
            }
        }
        ...
        public static UITextureAtlas LoadAtlas()
        {
            ...
            atlas = CreateTextureAtlas("ForestBrushAtlas", spriteNames, "ForestBrushRevisited.Resources.");
        ...
        public static UITextureAtlas? GetDefaultAtlas()
        {
            ...
            {
                return UIView.library?.Get<OptionsMainPanel>("OptionsPanel")?.GetComponent<UIPanel>()?.atlas;
            }
        }
        ...
        public static Dictionary<string, Texture2D> LoadBrushTextures()
        {
            ...
            string brushResourcePath = Path.Combine(GetModPath(), "Resources/Brushes");
            if (Directory.Exists(brushResourcePath))
            {
                foreach (var file in Directory.GetFiles(brushResourcePath))
                {
            ...
            {
                string sError = $"Brush path not found: {brushResourcePath}";
                Debug.Log(sError);
                Prompt.Info(Constants.ModName, sError);
            }
            ...
            {
                Debug.Log($"Custom brush path not found: {customBrushesPath}");
            }
        ...
        private static Shader? LoadCustomShaderFromBundle()
        {
            ...
            switch (Application.platform)
            {
                case RuntimePlatform.OSXPlayer:
                    bundleName = "ForestBrushRevisited.Resources.forestbrushmac";
                    break;
                case RuntimePlatform.LinuxPlayer:
                    bundleName = "ForestBrushRevisited.Resources.forestbrushlinux";
                    break;
                default:
                    bundleName = "ForestBrushRevisited.Resources.forestbrush";
                    break;
            }
            ...
            {
                Prompt.Info(Constants.ModName, $"Failed to find shader bundle: '{bundleName}'.");
                return null;
            }
        }
        ...
        public static byte[]? ExtractResource(string filename)
        {
            ...
            using (Stream resFilestream = a.GetManifestResourceStream(filename))
            {
                ...
                {
                    Debug.LogError($"Resource not found: {filename}");
                    return null;
                }
            }
        }
