...
namespace ForestBrushRevisited.GUI
{
    public class BrushOptionsSection : UIPanel
    {
        ...
        private void SetupSizePanel()
        {
            ...
            sizeSlider.value = ModSettings.Settings.SelectedBrush.Options.Size;
            sizeSlider.scrollWheelAmount = 1f;
            sizeSlider.eventValueChanged += SizeSlider_eventValueChanged;
            sizeSlider.eventMouseUp += SizeSlider_eventMouseUp;
            sizeSlider.backgroundSprite = ResourceLoader.WhiteRect;
            sizeSlider.tooltip = ModSettings.Settings.SelectedBrush.Options.Size.ToString();
        ...
        {
            ModSettings.Settings.SelectedBrush.Options.Size = value;
            sizeSlider.tooltip = ModSettings.Settings.SelectedBrush.Options.Size.ToString();
        ...
        private void SetupStrengthPanel()
        {
            ...
            strengthSlider.value = ModSettings.Settings.SelectedBrush.Options.Strength;
        ...
        {
            ModSettings.Settings.SelectedBrush.Options.Strength = value;
        ...
        private void SetupDensityPanel()
        {
            ...
            densityLabel.isEnabled = !ModSettings.Settings.SelectedBrush.Options.AutoDensity;
            ...
            densitySlider.value = 16.0f - ModSettings.Settings.SelectedBrush.Options.Density;
            ...
            densitySlider.isEnabled = !ModSettings.Settings.SelectedBrush.Options.AutoDensity;
        ...
        private void DensitySlider_eventValueChanged(UIComponent component, float value)
        {
            ...
            ModSettings.Settings.SelectedBrush.Options.Density = 16f - value;
        }
        ...
        private void SetupAutoDensityPanel()
        {
            ...
            autoDensityCheckBox.isChecked = ModSettings.Settings.SelectedBrush.Options.AutoDensity;
            autoDensityCheckBox.eventCheckChanged += AutoDensityCheckBox_eventCheckChanged;
